        ...
        {!loaded ? (
          ...
          <div>
            {!outputUrl && !processing && (
              <div style={{ border: '2px dashed #cbd5e1', padding: '30px 20px', borderRadius: '16px', backgroundColor: '#f8fafc' }}>
                <p style={{ marginBottom: '15px', color: '#333' }}>Επιλέξτε αρχείο .m4a:</p>
                <input 
                  type="file" 
                  accept=".m4a" 
                  ref={fileInputRef}
            ...
            {processing && (
              <div style={{ margin: '20px' }}>
                ...
                <p style={{ fontSize: '12px', color: '#64748b' }}>{fileName}</p>
              </div>
            )}
            ...
            {outputUrl && (
              <div style={{ marginTop: '10px' }}>
                <div style={{ padding: '15px', backgroundColor: '#f0fdf4', borderRadius: '12px', marginBottom: '20px' }}>
                  <h3 style={{ color: '#166534', margin: '0 0 10px 0' }}>✓ Ολοκληρώθηκε!</h3>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  <a 
                    ...
                    onClick={() => setTimeout(resetConverter, 3000)}
                    style={{ padding: '14px', background: '#166534', color: 'white', textDecoration: 'none', borderRadius: '10px', fontWeight: 'bold' }}
                  >
                    Download MP3
                  </a>
                  <button 
                    onClick={resetConverter} 
                    style={{ padding: '12px', background: 'transparent', color: '#64748b', border: '1px solid #cbd5e1', borderRadius: '10px', cursor: 'pointer' }}
                  >
                    Νέα Μετατροπή
                  </button>
                </div>
